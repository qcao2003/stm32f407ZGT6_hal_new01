...
#define	FCS_SET       HAL_GPIO_WritePin(T_CS_GPIO_Port, T_CS_Pin, GPIO_PIN_SET)     //片选信号 PC13
#define	FCS_CLR  	    HAL_GPIO_WritePin(T_CS_GPIO_Port, T_CS_Pin, GPIO_PIN_RESET)   //片选信号 PC13

#define	FDI_SET       HAL_GPIO_WritePin(T_MOSI_GPIO_Port, T_MOSI_Pin, GPIO_PIN_SET)      //数据输出 PF11
#define	FDI_CLR       HAL_GPIO_WritePin(T_MOSI_GPIO_Port, T_MOSI_Pin, GPIO_PIN_RESET)     //数据输出 PF11

#define	FDO_IN        HAL_GPIO_ReadPin(T_MISO_GPIO_Port, T_MISO_Pin)   //数据输入 PB2


#define	FCLK_SET      HAL_GPIO_WritePin(TSCK_GPIO_Port, TSCK_Pin, GPIO_PIN_SET)   //数据时钟线  PB0
#define	FCLK_CLR      HAL_GPIO_WritePin(TSCK_GPIO_Port, TSCK_Pin, GPIO_PIN_RESET) //数据时钟线  PB0
