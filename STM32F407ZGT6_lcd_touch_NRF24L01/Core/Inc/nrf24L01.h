...
#define	W25QXX_CS_SET 		HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_SET)  		//W25QXX的片选信号
#define	W25QXX_CS_RESET 		HAL_GPIO_WritePin(SPI1_CS_GPIO_Port, SPI1_CS_Pin, GPIO_PIN_RESET)
...
#define NRF24L01_IRQ_PIN_READ()                       HAL_GPIO_ReadPin(NRF_IQR_GPIO_Port,NRF_IQR_Pin)
